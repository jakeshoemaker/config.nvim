...
require('lazy').setup({
  ...
  -- file explorer extension for telescope
  {
  ...
  'vimwiki/vimwiki',
  {
    ...
    config = function()
      require("chatgpt").setup({
        ...
        api_key_cmd = "bw get notes 348de253-be80-49c3-b3e7-952980fd1293"
      })
    end,
    dependencies = {
...
vim.keymap.set('n', '<leader>dqf', ':lua vim.diagnostic.setqflist()<CR>', { silent = true })
